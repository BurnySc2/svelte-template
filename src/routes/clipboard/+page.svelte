...
<div class="mx-auto max-w-2xl space-y-6 p-8">
    ...
    <div class="space-y-3">
        ...
        {#if copied_text}
            <div class="rounded bg-gray-100 p-2 text-sm">Last copied: <code>{copied_text}</code></div>
        {/if}
    </div>
    ...
    <div class="space-y-3">
        ...
        {#if pasted_text}
            <div class="max-h-20 overflow-auto rounded bg-gray-100 p-2 text-sm">Pasted: <code>{pasted_text}</code></div>
        {/if}
    </div>
